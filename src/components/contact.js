  ...
  return (
    <div className="contact">
      <form className="contact__form">
        ...
        <div className="contact__messageSucceed">Thank you for your message!</div>
      </form>
      <div className="contact__informations">
        <h2 className="contact__info">
          <i className="far fa-envelope"> </i> suntzu@.com
        </h2>
        <h2 className="contact__info">
          <i className="fas fa-phone" /> +48 123 456 789
        </h2>
        <h2 className="contact__info">
          <i className="fab fa-facebook-f" /> /suntzu
        </h2>
      </div>
    </div>
  );
